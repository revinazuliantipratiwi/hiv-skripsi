...
class HivExport implements FromArray, WithHeadings, WithEvents
{
    protected $data;
    protected $totalKasus;

    public function __construct($data)
    {
        $this->data = $data;
        $this->totalKasus = $data->sum('total_kasus');
    }
    ...
    public function array(): array
    {
        ...
        // Baris total kasus: kolom 1-3 dikosongkan dulu karena nanti di merge
        $result[] = [
            'Total Kasus', // Ini akan ada di kolom 1, tapi nanti akan merge kol 1-3 jadi terlihat di tengah
            '',            // kolom 2
            '',            // kolom 3
